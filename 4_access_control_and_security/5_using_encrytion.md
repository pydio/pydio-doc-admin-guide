_One of the main reason the encryption feature has been made available in cells is to make sure data are still over control when using a storage provided by a third party._
