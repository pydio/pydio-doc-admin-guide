You can define quotas to limit the amount of storage that can be used on a workspace basis, this tool will grant you control over the size of your storages therefore allowing you to be cost effective.
