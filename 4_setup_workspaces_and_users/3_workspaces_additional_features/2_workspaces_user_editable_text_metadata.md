...
<span style="padding: 10px;display: inline-block;">This documentation is for Pydio 7. Looking for <a href="https://pydio.com/en/docs/v8/user-editable-text-metadata">Pydio 8 docs?</a></span>
</div>
