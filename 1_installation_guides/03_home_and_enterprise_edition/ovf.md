...
where "VERSION" is the release version of Pydio Cells. Get for example: [https://download.pydio.com/pub/cells-enterprise/release/1.5.3/ovf/Cells-Enterprise-OVF-1.5.3.zip](https://download.pydio.com/pub/cells-enterprise/release/1.5.3/ovf/Cells-Enterprise-OVF-1.5.3.zip). An md5 file is also available on the same location for integrity verification.
