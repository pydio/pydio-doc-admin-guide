...
where "VERSION" is the release version of Pydio Cells. Get for example: [https://download.pydio.com/pub/cells-enterprise/release/1.6.0/ovf/Cells-Enterprise-OVF-1.6.0.zip](https://download.pydio.com/pub/cells-enterprise/release/1.6.0/ovf/Cells-Enterprise-OVF-1.6.0.zip). An md5 file is also available on the same location for integrity verification.
